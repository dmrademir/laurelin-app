        ...
        <div className="drinks-showcase-header">
          ...
          <div className="drinks-subtitle-container">
            <p className="subtitle">
              Receitas exclusivas que elevam o hidromel a novas dimensões de
              sabor
            </p>
          </div>
        </div>
        ...
        <div className="drinks-grid">
          ...
          <div className="drink-recipe-card">
            ...
            <p className="drink-method">
              Em um copo com gelo, combine 30ml de Vermouth Rosso, 30ml de
              Campari e 30ml de Laurelin. Mexa bem e decore com casca de
              laranja. Serve-se em copo old fashioned com gelo.
            </p>
          </div>
          ...
          <div className="drink-recipe-card">
            ...
            <span className="drink-section-label">Modo de Preparo:</span>
            <p className="drink-method">
              Em um copo com gelo, adicione 15ml de suco de limão fresco, 15ml
              de xarope de gengibre e 60ml de Laurelin. Complete com água com
              gás e mexa suavemente. Decore com rodela de limão e gengibre
              fresco.
            </p>
          </div>
          ...
          <div className="drink-recipe-card">
            ...
            <span className="drink-section-label">Modo de Preparo:</span>
            <p className="drink-method">
              Em um coqueteleira, combine 45ml de suco de abacaxi fresco, 60ml
              de Laurelin e uma clara de ovo. Agite vigorosamente por 15
              segundos. Coe em copo com gelo e polvilhe canela em pó na espuma.
            </p>
          </div>
          ...
          <div className="drink-recipe-card">
            ...
            <span className="drink-section-label">Modo de Preparo:</span>
            <p className="drink-method">
              Em um copo com gelo, combine 45ml de gin premium e 45ml de
              Laurelin. Aperte uma fatia de limão siciliano fresco sobre a
              bebida e adicione a casca como decoração. Mexa suavemente e
              aprecie a harmonia.
            </p>
          </div>
        </div>
