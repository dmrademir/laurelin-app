...
export default function Contato() {
	...
	const handleSendEmail = (e) => {
		...
		console.log("DEBUG EMAIL_TEMPLATE_ID:", import.meta.env.VITE_EMAILJS_TEMPLATE_ID);
	...
	return (
		...
		<div className="contact-text">
		<h4>WhatsApp</h4>
		<a href="https://wa.me/5511978727672" target="_blank" rel="noopener noreferrer" className="pairing-subtitle">(11) 97872-7672</a>
