...
export default function Contato() {
  ...
  const handleSendEmail = (e) => {
    ...
    emailjs
      ...
      .then(() => {
        alert(
          "Mensagem enviada com sucesso! A Laurelin entrará em contato em breve.",
        );
            ...
            <div className="contact-info-top">
              ...
              <div className="contact-method">
                ...
                <div className="contact-text">
                  <h4>WhatsApp</h4>
                  <a
                    href="https://wa.me/5511978727672"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="pairing-subtitle"
                  >
                    (11) 97872-7672
                  </a>
          ...
          >
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                rows="5"
                placeholder="Conte-nos mais sobre sua dúvida ou pedido..."
                required
              ></textarea>
            </div>
